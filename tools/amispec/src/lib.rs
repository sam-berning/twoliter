...
use aws_sdk_ec2::types::{ArchitectureValues, BlockDeviceMapping as SdkBlockDeviceMapping};
use bon::Builder;
...
impl From<Architecture> for ArchitectureValues {
...
mod test {
    ...
    #[test_case(
        TemplatedAmiSpec::builder()
            .name("my-ami")
            .architecture(Templated::raw(Architecture::X86_64))
            .root_device_name("/dev/xvda")
            .boot_mode(BootMode::UefiPreferred)
            .description("a very cool ami")
            .ena_support(true)
            ...
            .virtualization_type(VirtualizationType::Hvm)
            .block_device_mapping(
                TemplatedBlockDeviceMapping::builder()
                    .ebs(
                        TemplatedGp3::builder()
                            .snapshot_id("snap-12345678")
                            .delete_on_termination(true)
                            .volume_size(BoundedU64::new(4).unwrap())
                            .build(),
                    )
                    .build_with_device_name("/dev/xvda"))
            .build(),
    ...
    #[test_case(
        TemplatedAmiSpec::builder()
            .name("{{ ami.name }}")
            .architecture(Templated::template("{{ variant.arch }}"))
            .build(),
        hashmap! {
            "ami" => hashmap! {
                "name" => "my-ami"
    ...
    #[test_case(
        TemplatedAmiSpec::builder()
            ...
            .block_device_mapping(
                TemplatedBlockDeviceMapping::builder()
                    .ebs(
                        TemplatedIo2::builder()
                            .snapshot_id("{{ data_volume_snapshot }}")
                            .delete_on_termination(true)
                            .iops(BoundedU64::new(1000).unwrap())
                            .volume_size(BoundedU64::new(4).unwrap())
                            .build(),
                    )
                    .build_with_device_name("/dev/xvda"))
    ...
    fn test_render_templated_amispec_to_sdk(
        templated_amispec: TemplatedAmiSpec,
